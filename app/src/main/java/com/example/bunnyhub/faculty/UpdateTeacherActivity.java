...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private EditText updateTeacherName,updateEmail,updatePost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTeacherName=findViewById(R.id.update_name);
        ...
        updateBtn=findViewById(R.id.update_teacherBtn);
        deleteBtn=findViewById(R.id.delete_teacherBtn);
